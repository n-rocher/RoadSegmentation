"""
AUTHOR : https://github.com/hamidriasat/DDRNets
"""
...
"""
def DDRNet_23_Slim(num_classes, input_shape=[1024, 2048, 3], layers_arg=[2, 2, 2, 2], planes=32, spp_planes=128, head_planes=64, scale_factor=8, augment=False):
    ...
    model = models.Model(inputs=[x_in], outputs=[model_output], name="DDRNet_23_Slim")
